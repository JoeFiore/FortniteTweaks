...
REM ============================================================
REM Keyboard 0 Delay Tweak Execution
REM Corresponds to Option [4] from the main menu
REM ============================================================

:KEYBOARD0
echo.
echo ============================================
echo  Applying Keyboard 0 Delay Tweaks
...
reg add "HKLM\SYSTEM\CurrentControlSet\Services\i8042prt\Parameters" /v "PollRate" /t REG_DWORD /d 1 /f >nul
reg add "HKLM\SYSTEM\CurrentControlSet\Services\kbdhid\Parameters" /v "PollingInterval" /t REG_DWORD /d 1 /f >nul
...
echo.
echo Keyboard 0 Delay tweaks applied successfully!
pause